...
references: ["B1.3", "I5.3", "A2.1", "A2.2"]
docsSources: ["https://code.claude.com/docs/en/security", "https://code.claude.com/docs/en/mcp", "https://code.claude.com/docs/en/permissions"]
---
