---
id: "A1.4"
slug: "workflows-deterministic-runs"
title: "Workflows: deterministic multi-step runs"
type: "core"
order: 4
estimatedMinutes: 13
volatility: "volatile"
...
prerequisites: ["A1.1"]
teaches: ["workflows", "determinism-test", "resumable-runs"]
references: ["I3.1", "I6.1"]
docsSources: ["https://code.claude.com/docs/en/workflows"]
---

# Workflows: deterministic multi-step runs
