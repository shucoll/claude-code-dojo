...
references: ["I1.3", "I1.4", "I5.2", "I7.1"]
docsSources: ["https://code.claude.com/docs/en/server-managed-settings", "https://code.claude.com/docs/en/managed-mcp", "https://code.claude.com/docs/en/admin-setup", "https://code.claude.com/docs/en/memory"]
---
