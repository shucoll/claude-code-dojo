...
references: ["I7.1", "A3.3"]
docsSources: ["https://code.claude.com/docs/en/plugin-marketplaces", "https://code.claude.com/docs/en/plugin-dependencies", "https://code.claude.com/docs/en/plugin-relevance"]
---
